    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
      <div class="container">
        ...
        <a class="navbar-brand" href="#">
          <img src="image/logo.jpg" width="80" height="80" alt="Logo" class="d-inline-block align-top"> Orlando Gourmet
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
              <a class="nav-link" href="http://localhost/curso/laravel/og_laravel/public/login">Administracion</a>
            </li>                          
          </ul>
        </div>
